...
class Pizza{
  ...
  void vegpizza(){
       ...
       prize+= vegp[cho].second * quantity;
    ...
    void nonvegpizza(){
       ...
       prize+= nonvegp[cho].second * quantity;
    }
...
class Burgers{
    ...
    void nonvegburgers(){
       ...
       prize+= nonveg[chh].second * quantity;
    }
...
class Beverages{
    ...
    void beveragetype(){
       ...
       prize+= beverage[chh].second * quantity;
...
class Desserts{
    ...
    void dessertstype(){
       ...
       prize+= dessert[choi].second * quantity;
...
class Sides{
    ...
    void sidestype(){
       ...
       prize+= sides[choi].second * quantity;
...
int main(){
    ...
    food foo;
    displaybill();
    cout<<"Your total price is : "<<prize<<endl;
    return 0;
}
